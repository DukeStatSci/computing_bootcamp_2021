...
slide decks, and exampls will serve to
...
- Live service status dashboard available at https://status.oit.duke.edu/
...
The DSS has an RStudio Workbench (formerly Pro) license that will allow you to connect to an instance of RStudio (and Jupyter) in your browser while harnessing the computing power of a remote multiprocessor server.
...
- RStudio Connect
  ...
  - if you need access, ask and we can help get you set-up

- Email aliases: https://stat.duke.edu/resources/email/aliases
  
- Departmental IT resources page is coming soon
