...
The DSS has an RStudio Workbench (formerly Pro) license that will allow you to connect to an instance of RStudio in your browser while harnessing the computing power of a remote multiprocessor server.
